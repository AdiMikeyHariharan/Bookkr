...
const Writings = () => {
  return (
    <div className="container w-4/5 mx-auto translate-y-10 bg-gradient-to-r from-blue-50 to-white p-7 rounded-lg shadow-lg">
      <ul className="text-sm font-medium text-gray-800 sm:flex sm:space-x-9">
        <li className="w-full mb-7 sm:mb-0">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1 text-base">
              <ReactTyped
                strings={[
                  "<span style='font-weight: bold; font-size: 1.25rem;'>Your pick of rides at low prices</span><br/><br/>&emsp;No matter where you’re going, by bus or carpool, find the perfect ride from our wide range of destinations and routes at low prices.",
                ]}
                typeSpeed={10}
        ...
        <li className="w-full mb-7 sm:mb-0">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1 text-base">
              <ReactTyped
                strings={[
                  "<span style='font-weight: bold; font-size: 1.25rem;'>Trust who you travel with</span><br/><br/>&emsp;We take the time to get to know each of our members and bus partners. We check reviews, profiles and IDs, so you know who you’re travelling with and can book your ride at ease on our secure platform.",
                ]}
                typeSpeed={10}
                className="text-black"
                contentType={'html'}
        ...
        <li className="w-full">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1 text-base">
              <ReactTyped
                strings={[
                  "<span style='font-weight: bold; font-size: 1.25rem;'>Scroll, click, tap and go!</span><br/><br/>&emsp;Booking a ride has never been easier! Thanks to our simple app powered by great technology, you can book a ride close to you in just minutes.",
                ]}
                typeSpeed={10}
                className="text-black"
                contentType={'html'}
